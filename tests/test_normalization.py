...
class TestNormalization:
    def test_character_normalization(self):
        source_file = "tests/data/characters.tsv"
    ...
    #     source_file = "tests/data/punctuation_space.tsv"
    #     source_file = open(source_file)
    ...
    def test_zw_normalization(self):
        source_file = "tests/data/zero_width.tsv"
        source_file = open(source_file)
    ...
    def test_halant_normalization(self):
        source_file = "tests/data/halant.tsv"
        source_file = open(source_file)
    ...
    def test_vowel_kar_normalization(self):
        source_file = "tests/data/vowel_kar.tsv"
        source_file = open(source_file)
    ...
    def test_normalizer(self):
        source_file = "tests/data/normalizer.tsv"
        source_file = open(source_file)
