...
class TestCleaning:
    def test_punctuation_cleaning(self):
        source_file = "tests/data/punct_cleaning.tsv"
    ...
    def test_multi_punctuation_cleaning(self):
        source_file = "tests/data/multi_punct_cleaning.tsv"
        source_file = open(source_file)
    ...
    def test_digit_cleaning(self):
        source_file = "tests/data/digit_cleaning.tsv"
        source_file = open(source_file)
    ...
    def test_multi_space_cleaning(self):
        source_file = "tests/data/multi_space_cleaning.tsv"
        source_file = open(source_file)
    ...
    def test_url_cleaning(self):
        source_file = "tests/data/url_cleaning.tsv"
        source_file = open(source_file)
    ...
    def test_html_cleaning(self):
        source_file = "tests/data/html_cleaning.tsv"
        source_file = open(source_file)
    ...
    def test_emoji_cleaning(self):
        source_file = "tests/data/emoji_cleaning.tsv"
        source_file = open(source_file)
    ...
    def test_special_char_cleaning(self):
        source_file = "tests/data/special_char_cleaning.tsv"
        source_file = open(source_file)
